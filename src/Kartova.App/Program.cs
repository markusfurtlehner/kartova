...
internal static class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        catch (Exception e)
        {
            ...
            Console.Error.WriteLine("Kartova failed to start.");
    ...
    private static bool TryVerifyDisplay(out string problem)
    {
        ...
        problem =
            """
            Kartova found no display server: neither DISPLAY nor WAYLAND_DISPLAY is set.

            Kartova is a graphical application and needs a desktop session.
